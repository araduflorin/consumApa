...
function myFunction(x){
    ...
    document.getElementById("id").value = x.cells[0].innerHTML;
    document.getElementById("indexBuc").value = x.cells[1].innerHTML;
    document.getElementById("indexBaie").value = x.cells[2].innerHTML;
    document.getElementById("indexWC").value = x.cells[3].innerHTML;
}
    /*
